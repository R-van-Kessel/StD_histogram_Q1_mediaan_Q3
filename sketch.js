...
function generateQuestions() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        // Sorteer alle waardes voor kwartielberekening
        ...
        q1 = round(q1 * 10) / 10;
        q1 = q1.toString().replace('.', ',');
        
        // Bereken Q3 (derde kwartiel)
        let q3;
        if (alleWaardes.length === 0) {
            q3 = 0;
        } else {
        ...
        q3 = round(q3 * 10) / 10;
        q3 = q3.toString().replace('.', ',');
        
        // Sla histogram data op
        questions.push({
            text: "HISTOGRAM",
            histogram: frequencies,
            answer: "gem:" + gemiddelde + "|q1:" + q1 + "|med:" + mediaan + "|q3:" + q3,
            answerId: i
        });
...
function mousePressed() {
  // Check of er op de titel geklikt wordt
    ...
    if (mouseX > titleX - titleWidth/2 && 
        ...
        mouseY > TITLE_Y && 
        mouseY < TITLE_Y + TITLE_SIZE) {
        window.open('https://r-van-kessel.github.io/Summon_the_Dragon/index.html', '_self'); //link opent op zelfde tabblad
    }
